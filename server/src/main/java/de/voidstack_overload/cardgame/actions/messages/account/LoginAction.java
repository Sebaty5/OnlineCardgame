...
public class LoginAction implements AccountAction {
    ...
    public Response execute(JsonObject json, WebSocket connection) {
        ...
        if(json.get("username") == null || json.get("password") == null) {
            ...
            return ResponseBuilder.build(MessageTypeServer.ERROR, jsonBuilder);
        }
        ...
        if(!DataBaseHandler.INSTANCE.isValidLogin(username, password)) {
            ...
            return ResponseBuilder.build(MessageTypeServer.ACCOUNT_LOGIN_DENY, jsonBuilder);
        }
        ...
        return ResponseBuilder.build(MessageTypeServer.ACCOUNT_LOGIN_ACCEPT, jsonBuilder);
    }
}
